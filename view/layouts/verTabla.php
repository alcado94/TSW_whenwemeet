...
$idAutor = $view->getVariable("idAutor");
...
<div class="container">
        ...
        <?php if($_SESSION['currentuser']==$poll['idAutor']){
            echo('<a href="');echo $link;echo('">');echo $link;echo('</a>');
        }?>
	<div class="edit-poll-set">
        ...
        <div class="edit-poll">
            <?php if($_SESSION['currentuser']==$poll['idAutor']){
                echo('    <a href="index.php?controller=poll&amp;action=edit&amp;id=');echo $poll['id'];echo('">
