                ...
                <form id="formT" class="logmod__container_add_day" action="index.php?controller=poll&amp;action=edit&amp;id=<?php echo $poll['Id'] ?>" method="POST">
                    ...
                    <?php
                        ...
                        <div class="schedule-day">
                            ...
                            <div>
                                <input class="input-date" type="date" name="dayPred[<?php echo $indexdia; ?>][0]" id="" value="<?php echo $key; ?>">
                            ...
                            <?php 
                                ...
                                <div class="schedule-date" id="dia0">
                                    <div class="schedule-date-pos">
                                        <input type="time" name="dayExist[<?php echo $poll['diasId'][$key][$i] ?>]" class="timeIn" value="<?php echo $valuehoras['Init']; ?>">
                                        <input type="time" name="dayExist[<?php echo $poll['diasId'][$key][$i++] ?>]" class="timeIn" value="<?php echo $valuehoras['End']; ?>">
                                    </div>
