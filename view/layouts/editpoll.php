                            ...
                            <?php 
                                ...
                                <div class="schedule-date" id="dia0">
                                    <div class="schedule-date-pos">
                                        <input type="time" name="dayExist[<?php echo $poll['diasId'][$key][0] ?>]" class="timeIn" value="<?php echo $valuehoras['Init']; ?>">
                                        <input type="time" name="dayExist[<?php echo $poll['diasId'][$key][1] ?>]" class="timeIn" value="<?php echo $valuehoras['End']; ?>">
                                    </div>
